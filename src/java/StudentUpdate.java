...
public class StudentUpdate extends HttpServlet {
    ...
    try
    {
                  ...
                  PreparedStatement ps = con.prepareStatement("update register set FNAME='"+FNAME+"' ,LNAME='"+LNAME+"',GENDER='"+GENDER+"' ,COUNTRY='"+COUNTRY+"',SEMESTER='"+SEMESTER+"',YEAR='"+YEAR+"',EMAIL_ID='"+EMAIL_ID+"'");
                   ps.executeUpdate();
                  out.print(St_Id);
                   out.print(FNAME);
                   out.print(LNAME);
