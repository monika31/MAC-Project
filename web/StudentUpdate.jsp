        ...
        String  fname, lname, gender, country, semester, year, email;
          ...
          // Establish the Connection
            ...
            while(rs.next())
                ...
                lname=rs.getString("");
                gender=rs.getString("");
                country=rs.getString("");
                semester=rs.getString("");
                year=rs.getString("");
                email=rs.getString("");
                %>
                <form >
                    Enter Email ID: <br>  <input type="text" name="Email_id" class="regis_text" >"<br><br>
                   
                </form>
                  <form name="register" action="admin.jsp"  method="post" onclick="return reg()" ><br>
