        ...
        <a href="StudentDelete.jsp">Delete</a>
            ...
            <div class="content">
                <div class="left_side">
                  ...
                  <form name="register" action="Home.jsp"   onclick="return reg()" ><br>
                    ...
                    Email_id: <br>  <input type="email" name="Email_id" class="regis_text"><br><br>
                    Password:<br> <input type="password" name="Password" class="regis_text"><br><br>
                    <input  type="button" value="register" class="button_design" onclick="location='Register.jsp'" />
                </form>
